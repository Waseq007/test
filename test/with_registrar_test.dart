import 'package:newproject/registrar.dart';
import 'package:flutter_test/flutter_test.dart';

import 'test_basis.dart';

void main() {
  test('change(360,360) = [] => reset, if change is zero', () {
    final reg =
        Registrar(price: 360, given: 360, registrar: [200, 100, 50, 10, 5]);
    reg.process();
    expect(reg.given, 0);
    expect(reg.price, 0);
    expect(eq(reg.payout, []), true);
    expect(eq(reg.registrar, [200, 100, 50, 10, 5]), true);
  });
